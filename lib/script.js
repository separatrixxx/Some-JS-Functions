...
function myPp() {
  ...
  document.getElementById("resultPop").innerHTML = "Возвращённое значение: " + arr.myPop() + " Изменившийся массив: " + arr;
}
...
function myPsh() {
  ...
  document.getElementById("resultPush").innerHTML = arr;
}
...
function myShft() {
  ...
  document.getElementById("resultShift").innerHTML = "Возвращённое значение: " + arr.myShift() + " Изменившийся массив: " + arr;
}
...
function myUnshft() {
  ...
  arr.myUnshift(valUnshift)

  document.getElementById("resultUnshift").innerHTML = arr;
}
